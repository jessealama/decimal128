...
export class RationalDecimal128 {
     ...
     *
     */
    abs(): RationalDecimal128 {
        if (this.isNegative) {
            return new RationalDecimal128(this.toString().substring(1));
        }
     ...
     * @param n
     */
    toDecimalPlaces(n: number): RationalDecimal128 {
        if (!Number.isInteger(n)) {
        ...
        if (undefined === rhs || 0 === n) {
            return new RationalDecimal128(lhs);
        }

        if (rhs.length <= n) {
            return new RationalDecimal128(s);
        }
     ...
     * @param x
     */
    cmp(x: RationalDecimal128): -1 | 0 | 1 {
     ...
     * @param x
     */
    subtract(x: RationalDecimal128): RationalDecimal128 {
        return new RationalDecimal128(
     ...
     * @param x
     */
    divide(x: RationalDecimal128): RationalDecimal128 {
        return new RationalDecimal128(
    ...
    round(n: number = 0): RationalDecimal128 {
        if (!Number.isInteger(n)) {
            throw new TypeError("Argument must be an integer");
        }
        ...
        return new RationalDecimal128(
            roundDigitStringTiesToEven(this.toString(), n)
        );
    }

    negate(): RationalDecimal128 {
        let s = this.toString();

        if (s.match(/^-/)) {
            return new RationalDecimal128(s.substring(1));
        }
     ...
     */
    remainder(d: RationalDecimal128): RationalDecimal128 {
        if (this.isNegative) {
